...
const expected = [
  ...
  "src/cache-friendly-compaction.ts", "src/compaction.ts", "src/context-converter.ts", "src/context-objects.ts", "src/context-pressure.ts", "src/context-protocol.ts", "src/context-spill.ts",
